...
/**
 * Pass the data array into passports. Passports are separated by a blank line,
 * and contain multiple key:value pairs separated by a space.
 */
fun passports() = data.split("\n\n")
    .map { passport ->
        passport
            .replace("\n", " ")
            .split(" ")
